//
// EnvelopeListProductModelsReadProduct.swift
//
...
public struct EnvelopeListProductModelsReadProduct: Codable, JSONEncodable, Hashable {
    ...
    public var resource: [ProductModelsReadProduct]?
    public var pageResult: PageResult?

    public init(message: String? = nil, details: [String]? = nil, resource: [ProductModelsReadProduct]? = nil, pageResult: PageResult? = nil) {
