//
// EnvelopeListProductModelsReadFeed.swift
//
...
public struct EnvelopeListProductModelsReadFeed: Codable, JSONEncodable, Hashable {
    ...
    public var resource: [ProductModelsReadFeed]?
    public var pageResult: PageResult?

    public init(message: String? = nil, details: [String]? = nil, resource: [ProductModelsReadFeed]? = nil, pageResult: PageResult? = nil) {
