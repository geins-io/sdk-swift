//
// SupplierModelsWriteSupplier.swift
//
...
/** A product supplier. */
public struct SupplierModelsWriteSupplier: Codable, JSONEncodable, Hashable {
    ...
    public init(name: String? = nil, address1: String? = nil, address2: String? = nil, address3: String? = nil, zipCode: String? = nil, country: String? = nil, contactPerson: String? = nil, phone1: String? = nil, phone2: String? = nil, email: String? = nil, externalId: String? = nil) {
        self.name = name
