//
// EnvelopeVariantModelsReadVariant.swift
//
...
public struct EnvelopeVariantModelsReadVariant: Codable, JSONEncodable, Hashable {
    ...
    public var resource: [VariantModelsReadVariant]?
    public var pageResult: PageResult?

    public init(message: String? = nil, details: [String]? = nil, resource: [VariantModelsReadVariant]? = nil, pageResult: PageResult? = nil) {
