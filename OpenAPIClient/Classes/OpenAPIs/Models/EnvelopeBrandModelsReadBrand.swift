//
// EnvelopeBrandModelsReadBrand.swift
//
...
public struct EnvelopeBrandModelsReadBrand: Codable, JSONEncodable, Hashable {

    /** A status message for the action taken. */
    public var message: String?
    /** Any validation messages for the data on the current action. */
    public var details: [String]?
    public var resource: BrandModelsReadBrand?
    public var pageResult: PageResult?

    public init(message: String? = nil, details: [String]? = nil, resource: BrandModelsReadBrand? = nil, pageResult: PageResult? = nil) {
