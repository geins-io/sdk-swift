...
public struct EnvelopeString: Codable, JSONEncodable, Hashable {
    ...
    public init(message: String? = nil, details: [String]? = nil, resource: [String]? = nil, pageResult: PageResult? = nil) {
